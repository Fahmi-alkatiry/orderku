    ...
    switch (status) {
      ...
      default:
        return {
          ...
          instruction:
            "Silahkan menuju kasir dan sebutkan Nomor Order di atas.",
        };
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-500">
        ...
        <div
          ...
          } flex items-center justify-center mb-6 mx-auto animate-bounce`}
        >
          {config.icon}
        </div>
        ...
        <p className="text-gray-500 mb-8">{config.desc}</p>
